...
#IP adresses of the vibrators [back, right knee, left knee] & UDP Port
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    ...
    playsound(f"{path}/calibration.mp3", block= True)
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if any(abs(i)<160 for i in angle_knee) : 
                ...
                elif any(heel_init[i][1] - heel[i][1] > 0.02 for i in range(2)):
                        tab_pb_int.append(2)
                ...
                elif abs(ligne_gaze_init[ind_side] - ligne_gaze[ind_side]) > 8 : 
                ...
                #if no error is detected, the posture is good
                else :      
                    tab_pb_int.append(0)
